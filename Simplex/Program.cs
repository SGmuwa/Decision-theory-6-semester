...
public class TPR_6sem_1Laba {
    public static void Main(string[] args) {
        ...
        while(true){
            ...
            double Fxc=0;
            Console.WriteLine("Значение функции максимальной точки симлекса:"+ objectiveFunction(mas)+";     Значение функции в отраженной вершине:"+objectiveFunction(reflectedVertex));
            if(objectiveFunction(reflectedVertex)< objectiveFunction(mas)){//Наблюдается уменьшение целевой функции
                ...
                for(int i=0;i<centerOfGravityXc.Length;i++) Console.Write(centerOfGravityXc[i]+"\t");
            }
